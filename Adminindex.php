...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="Adminhome.php" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 商品管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="javascript:void(0)" name="Products_List.php"  title="商品类表" class="iframeurl"><i class="icon-double-angle-right"></i>商品类表</a></li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="transaction.php" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                            ...
                            <li class="home"><a href="javascript:void(0)" name="Orderform.php" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
                            <li class="home"><a href="javascript:void(0)" name="Amounts.php" title="交易金额"  class="iframeurl"><i class="icon-double-angle-right"></i>交易金额</a></li>
                            <li class="home"><a href="javascript:void(0)" name="Refund.php" title="退款管理"  class="iframeurl"><i class="icon-double-angle-right"></i>退款管理</a></li>
                        </ul>
                    </li>
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="Adminhome.php">  </iframe>
...
<div class="footer_style" id="footerstyle">
    ...
    <p class="l_f">版权所有：HQU14信息管理与信息系统田春雨</p>
    <p class="r_f">地址：华侨大学  邮编：210011 技术支持：周彩云</p>
</div>
<!--修改密码样式-->
