 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="picture-add.php" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
        <a href="javascript:ovid()" class="btn btn-danger"><i class="icon-trash"></i>批量删除</a>
       </span>
       <span class="r_f">共：<b><?php echo count($pros);?></b>件商品</span>
     </div>
     <!--产品列表展示-->
    ...
    <?php  foreach($pros as $pro):?>
     <tr>
        ...
        <td width="50px"><?php echo $pro['go_bianhao'];?></td>
        <td width="100px"><u style="cursor:pointer" class="text-primary" onclick=""><?php echo $pro['go_name'];?></u></td>
        <td width="100px"><?php echo $pro['cl_id'];?></td>
        <td width="250px"><?php echo $pro['go_specType'];?></td>
        <td width="250px"><?php echo $pro['attribute'];?></td>
        <td width="180px">2014-6-11 11:11:42</td>
         <?php
         if($pro['go_Status']==1){
             echo " <td>通过 </td>";
         }elseif ($pro['go_Status']==0){
             echo " <td><a onclick=AuditPro({$pro['go_id']})>待审核</a> </td>";
         }else{
             echo " <td>下架 </td>";
         }
         ?>
...
function AuditPro(id){
    alert(id);
    window.location.href="Products_Audit.php?id="+id;
}
</script>
